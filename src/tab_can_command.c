                                               ...
                                               WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE: {
        ...
        /* Row 1: CAN ID */
        CreateLabel(hwnd, hInst, -1, cx, cy + 3, 60, 20, L"CAN ID:", pData->hFont);
        pData->hEditCanId = CreateWindowExW(WS_EX_CLIENTEDGE, L"EDIT", L"101",
            WS_CHILD | WS_VISIBLE | ES_AUTOHSCROLL,
            cx + 68, cy, 120, 22, hwnd, (HMENU)IDC_EDIT_CAN_ID, hInst, NULL);
        SendMessageW(pData->hEditCanId, WM_SETFONT, (WPARAM)pData->hFont, TRUE);
        CreateLabel(hwnd, hInst, -1, cx + 196, cy + 3, 40, 20, L"(Hex)", pData->hFont);
        cy += lineH;

        /* Row 2: Frame Format */
        CreateLabel(hwnd, hInst, -1, cx, cy + 3, 60, 20,
            L"\x5E27\x683C\x5F0F:", pData->hFont);
        pData->hRadioStdFrame = CreateWindowExW(0, L"BUTTON",
            L"\x6807\x51C6\x5E27",
            WS_CHILD | WS_VISIBLE | BS_AUTORADIOBUTTON | WS_GROUP,
            cx + 68, cy, 80, 22, hwnd, (HMENU)IDC_RADIO_STD_FRAME, hInst, NULL);
        ...
        pData->hRadioExtFrame = CreateWindowExW(0, L"BUTTON",
            ...
            cx + 152, cy, 80, 22, hwnd, (HMENU)IDC_RADIO_EXT_FRAME, hInst, NULL);
        ...
        pData->hEditCanData = CreateWindowExW(WS_EX_CLIENTEDGE, L"EDIT",
            ...
            WS_CHILD | WS_VISIBLE | ES_AUTOHSCROLL,
            cx + 68, cy, 280, 22, hwnd, (HMENU)IDC_EDIT_CAN_DATA, hInst, NULL);
        ...
        int grp3X = margin;
        int grp3Y = grp1Y + grp1H + 8;
        int grp3W = grp1W + 12 + grp2W;
        int grp3H = 260;
        CreateWindowExW(0, L"BUTTON",
        ...
        pData->hCheckAutoScroll = CreateWindowExW(0, L"BUTTON",
            ...
            cx, cy, 100, 22, hwnd, (HMENU)IDC_CHECK_AUTOSCROLL, hInst, NULL);
        ...
        pData->hBtnClearMonitor = CreateWindowExW(0, L"BUTTON",
            L"\x6E05\x9664",
            WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
            cx + 110, cy, 70, 24, hwnd, (HMENU)IDC_BUTTON_CLEAR_MONITOR, hInst, NULL);
