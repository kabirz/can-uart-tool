...
/* Export macro: static build = empty; DLL build = dllexport/dllimport */
#if defined(LORA_SDK_STATIC)
  #define LORA_SDK_API
#elif defined(LORA_SDK_EXPORTS)
  #define LORA_SDK_API __declspec(dllexport)
#else
  #define LORA_SDK_API __declspec(dllimport)
#endif
